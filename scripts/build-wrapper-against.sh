...
#
# The version rewrite goes through scripts/facebook.cs, a .NET file-based app (see
...
WRAPPER="src/Maui.Facebook.Core/Maui.Facebook.Core.csproj"
CONFIGURATION="${BUILD_CONFIGURATION:-Release}"

case "$PLATFORM" in
  android) TFM="net10.0-android"; PACKAGE_ID="Kebechet.Maui.Facebook.Core.Android" ;;
  ios)     TFM="net10.0-ios";     PACKAGE_ID="Kebechet.Maui.Facebook.Core.iOS" ;;
...
dotnet run scripts/facebook.cs -- set-package-version "$WRAPPER" "$PACKAGE_ID" "$VERSION"
